# -*- coding: utf-8 -*-
#
# openprocurement.auctions.lease documentation build configuration file
#
...
man_pages = [
    ('index', 'openprocurementauctionslease', u'openprocurement.auctions.lease Documentation',
     [u'Myroslav Opyr', u'Volodymyr Bergman'], 1)
]
...
texinfo_documents = [
  ('index', 'openprocurementauctionslease', u'openprocurement.auctions.lease Documentation',
   u'Volodymyr Bergman', 'openprocurementauctionslease', 'One line description of project.',
   'Miscellaneous'),
]
...
# Reference: https://github.com/sphinx-doc/sphinx-intl
